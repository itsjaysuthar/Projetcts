    ...
    main_layout = dbc.Container(
        dbc.Jumbotron(
                [
                    ...
                    dbc.Textarea(id = 'textarea', className="mb-3", placeholder="Enter the Review", value = "The watch fits well but the quality is not good", style = {'height': '150px'}),
                    dbc.Container([
                        dcc.Dropdown(
                    id='dropdown',
...
def update_app_ui(n_clicks, textarea):
    ...
    if (result_list[0] == 0 ):
        ...
        return dbc.Alert("Unknown", color="yellow")
